...
void main() {
  ...
  group('Validate password', () {
    test("Check password field is null", () {
      ...
      expect(result, equals('O Campo Senha é obrigatório!'));
    });
    ...
    test("Check user field is more than 2 characters", () {
      ...
      expect(result, equals('O Campo Senha deve ter pelo menos 2 caracteres!'));
    });

    test("Check password field has special characters", () {
      final result = passwordValidator.validate(password: '123&');

      expect(result, equals('O Campo Senha contém caracteres especiais!'));
    });
    ...
    test("Check password field is less than 20 characters", () {
      ...
      expect(result, equals('O Campo Senha deve ser menor que 20 caracteres!'));
    });

    test("Check password field is space at the end", () {
      final result = passwordValidator.validate(password: '123 ');

      expect(result, equals('O Campo Senha não deve conter espaço no final!'));
    });
